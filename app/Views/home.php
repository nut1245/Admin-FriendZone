        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Coming Soon</a></li>
              <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Coming Soon</a></li>
              <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Coming Soon</a></li>
            </ul>
          </div>
        </li>
        <!-- <li class="nav-item menu-items">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row justify-content-between ">
                    ...
                    <div class="dropdown ">
                      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ตัวกรองข้อมูล </button>
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                        <a class="dropdown-item" href="#">ยืนยันแล้ว</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">รอการยืนยัน</a>
                      </div>
                    </div>
                  </div>
